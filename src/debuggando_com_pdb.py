...
# OBS: A utilização do print() pra debuggar código é uma prática ruim.
...
# O debug é utilizado durante o desenvolvimento, custumamos realizar todos imports de bibliotecas
# no inicio do arquivo. Por isso, ao ínves de colocarmos o import do pdb no início do arquivo.
# nós colocamos somente onde vamos debuggar, e ao finalizar já fazemos o teste e a remoção.
