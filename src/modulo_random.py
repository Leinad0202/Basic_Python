...
# Ao realizar o import de todo o módulo, todas as funçóes, atributos, classes e propriedades que estiverem
# demtrp do módulo ficarão disponiveis (Ficarão em Mémoria). Caso você saiba quais funções você precisa utilizar
