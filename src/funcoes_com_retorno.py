...
OBS: Não precisamos necessariamente criar uma varíavel para receber o retorno
...
2 - Podemos ter, em uma funçãom, diferentes returns;
...
# Exemplo 2 - Podemos ter, em uma funçãom, diferentes returns;
